...
public class PatronagePerson implements Serializable {
    ...
    @NotNull
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "patronage_person_seq")
    @SequenceGenerator(sequenceName = "PATRONAGE_PERSON_ID_SEQ", allocationSize = 1, name = "patronage_person_seq")
    @Column(name = "ID")
    private Integer id;
