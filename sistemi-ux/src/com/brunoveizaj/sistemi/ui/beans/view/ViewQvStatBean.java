...
public class ViewQvStatBean implements Serializable {
	...
	public void init()
	{
    	...
    	{
    	     MunicipalityDTO m = new HelperService().findMunicipality(Integer.valueOf(municipId));
    	     this.regionId = m.getRegion().getId();
    	     this.municipId = m.getId();
	...
	public void loadInteres()
	{
		if(lastQvId == null || (lastQvId != qvId))
		{
			...
			this.qvPois = null;//query ktu
			this.stats = new QvStatsService().getQvStatistic(qvId);
		}
	}
